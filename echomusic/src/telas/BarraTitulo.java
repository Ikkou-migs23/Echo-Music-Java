...
public class BarraTitulo extends JPanel {
    ...
    private JButton criarBotaoFechar(JFrame janela) {
        ...
        fechar.setForeground(Tema.BRANCO);
        fechar.setBackground(Tema.VERMELHO);
        fechar.setPreferredSize(new Dimension(ALTURA, LADO_BOTAO));
        ...
        fechar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                fechar.setBackground(Tema.VERMELHO_HOVER);
            }
