...
public class TelaLogin extends JFrame {
    ...
    private void autenticar(JTextField nome, JPasswordField senha) {
        if (nome.getText().isBlank() || senha.getPassword().length == 0) {
            JOptionPane.showMessageDialog(this,
                    "Preencha nome e senha para entrar.",
                    "Campos obrigatórios",
    ...
    private JButton adicionarBotaoPrincipal(JPanel painel, GridBagConstraints gbc, String texto) {
        ...
        Tema.aplicarHover(botao, Tema.ROXO, Tema.ROXO_ESCURO);
    ...
    private void adicionarLinkEsqueceuSenha(JPanel painel, GridBagConstraints gbc) {
        ...
        redefinir.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                JOptionPane.showMessageDialog(TelaLogin.this,
                        "A redefinição de senha estará disponível em breve.",
                        "Echo Music",
