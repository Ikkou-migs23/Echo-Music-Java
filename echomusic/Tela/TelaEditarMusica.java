...
public class TelaEditarMusica extends JFrame {
    ...
    public TelaEditarMusica(Musica musica, Runnable aoSalvar) {
        this.musica = musica;
...
// --- ações ---
    private void salvar() {
        ...
        musica.setNome(txtNome.getText().trim());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new TelaEditarMusica(new Musica("Música de Teste"), () -> {}).setVisible(true));
    }
}
