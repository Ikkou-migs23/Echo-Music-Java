...
public class TelaPerfil extends JFrame {
    ...
    private JPanel criarColunaInformacoes() {
        ...
        salvar.setPreferredSize(new Dimension(180, 30));
        salvar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Tema.aplicarHover(salvar, Tema.ROXO, Tema.ROXO_ESCURO);
        salvar.addActionListener(e -> salvarAlteracoes());

        JButton sair = new JButton("SAIR DA CONTA");
        sair.setFont(Tema.FONTE_SUBTITULO);
        sair.setForeground(Tema.BRANCO);
        sair.setFocusPainted(false);
        sair.setBorderPainted(false);
        sair.setPreferredSize(new Dimension(180, 30));
        sair.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Tema.aplicarHover(sair, Tema.VERMELHO, Tema.VERMELHO_ESCURO);
        sair.addActionListener(e -> sairPerfil());
        ...
        linhaBotoes.setMaximumSize(new Dimension(340, 45));
        linhaBotoes.setPreferredSize(new Dimension(340, 45));

        linhaBotoes.add(salvar);
        linhaBotoes.add(Box.createHorizontalStrut(10));
        linhaBotoes.add(sair);
        linhaBotoes.add(Box.createHorizontalGlue());
